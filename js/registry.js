...
export const TOOLS = [
  ...
  { id: 'pdf-table-extractor', name: 'PDF Table Extractor', category: 'documents', desc: 'Extract table-like PDF text to CSV', icon: ICONS.braces, needsPdfJs: true },
  ...
  { id: 'decision-matrix', name: 'Decision Matrix', category: 'math', desc: 'Score options with weighted criteria', icon: ICONS.delta },
  ...
  { id: 'status-update-builder', name: 'Status Update Builder', category: 'text', desc: 'Turn messy notes into crisp stakeholder updates', icon: ICONS.pen },
  { id: 'agenda-builder',    name: 'Meeting Agenda Builder', category: 'text',     desc: 'Create timed agendas from goals and notes', icon: ICONS.cal },
  { id: 'checklist-builder', name: 'Checklist Builder',     category: 'text',      desc: 'Convert process notes into clean checklists', icon: ICONS.diff },
  ...
  { id: 'csv-pivot-summary', name: 'CSV Pivot Summary',        category: 'developer', desc: 'Group CSV rows by column and summarize values', icon: ICONS.braces  },
