...
export const POCKETS = [
  ...
  {
    id: 'designer',
    name: 'PocketKit Designer',
    shortName: 'Designer',
    access: 'pro',
    desc: 'Image, layout, crop, color, and creator utilities.',
    accent: '#7c3aed',
  ...
  {
    id: 'student',
    name: 'PocketKit Student',
    shortName: 'Student',
    access: 'pro',
    desc: 'Writing, reading, notes, PDFs, and study helpers.',
    accent: '#d97706',
    featured: ['Reading time', 'Word counter', 'Photo to PDF', 'Merge PDF', 'Pomodoro'],
    tools: [
      'reading-time',
      'word-counter',
      'character-counter',
