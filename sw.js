...
//   css/styles.css?v=25  |  js/app.js?v=36  |  templates/*.html?v=5  |  js/tools/*.js?v=4
...
const SHELL_URLS = [
  ...
  'index.html',
  'manifest.json',
  'css/styles.css?v=25',   // matches <link> in index.html
  'js/app.js?v=36',        // matches <script> in index.html
  'js/registry.js?v=21',
  'js/router.js?v=22',
  'js/core/file.js',
  'js/core/lazy.js',
