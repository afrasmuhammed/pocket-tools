...
//   css/styles.css?v=30  |  js/app.js?v=42  |  templates/*.html?v=8  |  js/tools/*.js?v=7
...
const SHELL_URLS = [
  ...
  'index.html',
  'manifest.json',
  'css/styles.css?v=30',   // matches <link> in index.html
  'js/app.js?v=42',        // matches <script> in index.html
  'js/registry.js?v=22',
  'js/router.js?v=27',
  'js/core/file.js',
  'js/core/lazy.js',
