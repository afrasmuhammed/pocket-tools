...
//   css/styles.css?v=19  |  js/app.js?v=29  |  templates/*.html?v=5  |  js/tools/*.js?v=4
...
const SHELL_URLS = [
  ...
  'index.html',
  'manifest.json',
  'css/styles.css?v=19',   // matches <link> in index.html
  'js/app.js?v=29',        // matches <script> in index.html
  'js/registry.js?v=20',
  'js/router.js?v=21',
  'js/core/file.js',
  'js/core/lazy.js',
