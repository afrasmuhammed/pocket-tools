...
//   css/styles.css?v=16  |  js/app.js?v=23  |  templates/*.html?v=3  |  js/tools/*.js?v=2
...
const SHELL_URLS = [
  ...
  'js/app.js?v=23',        // matches <script> in index.html
  'js/registry.js?v=15',
  'js/router.js?v=15',
  'js/core/file.js',
  'js/core/lazy.js',
...
// ---------------------------------------------------------------------------
const TOOL_URLS = [
  // Tool modules (64) — router does: import(`./tools/${id}.js?v=2`)
  ...
  'js/tools/hmac-generator.js?v=2',
  ...
  'js/tools/timestamp-converter.js?v=2',
  ...
  // Tool templates (64) — router does: fetch(`templates/${id}.html?v=3`)
  ...
  'templates/hmac-generator.html?v=3',
  ...
  'templates/timestamp-converter.html?v=3',
