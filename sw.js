...
//   css/styles.css?v=41  |  js/app.js?v=66  |  templates/*.html?v=19  |  js/tools/*.js?v=24
...
const SHELL_URLS = [
  ...
  'index.html',
  'manifest.json',
  'css/styles.css?v=41',   // matches <link> in index.html
  'js/app.js?v=66',        // matches <script> in index.html
  'js/registry.js?v=30',
  'js/router.js?v=50',
  'js/core/access.js',
  'js/core/file.js',
