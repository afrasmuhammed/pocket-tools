...
//   css/styles.css?v=21  |  js/app.js?v=31  |  templates/*.html?v=5  |  js/tools/*.js?v=4
...
const SHELL_URLS = [
  ...
  'index.html',
  'manifest.json',
  'css/styles.css?v=21',   // matches <link> in index.html
  'js/app.js?v=31',        // matches <script> in index.html
  'js/registry.js?v=21',
  'js/router.js?v=22',
  'js/core/file.js',
  'js/core/lazy.js',
