...
- The homepage should explain the product and guide users into pockets, not show all 100 tools immediately.
...
- Do not position PocketKit as "100 free tools".
...
- Browsers usually cannot install 100 separate mini-apps from one PWA.
